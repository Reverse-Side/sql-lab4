...
from src.auth.dependencies import AuthAdmin, AuthUser, AuthAny
...
async def get_me(service: UserServiceDep, payload: AuthAny):
...
async def update_me(
    user_update: UserUpdate, service: UserServiceDep, payload: AuthAny
):
